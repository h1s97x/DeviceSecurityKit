#include "include/device_security_kit/device_security_kit_plugin.h"
...
#include "device_security_kit_plugin_private.h"
...
G_DEFINE_TYPE(DeviceSecurityKitPlugin, device_security_kit_plugin, g_object_get_type())
...
static void device_security_kit_plugin_class_init(DeviceSecurityKitPluginClass* klass) {
...
void device_security_kit_plugin_register_with_registrar(FlPluginRegistrar* registrar) {
