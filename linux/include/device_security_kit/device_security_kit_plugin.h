...
} DeviceSecurityKitPluginClass;

FLUTTER_PLUGIN_EXPORT GType device_security_kit_plugin_get_type();

FLUTTER_PLUGIN_EXPORT void device_security_kit_plugin_register_with_registrar(
